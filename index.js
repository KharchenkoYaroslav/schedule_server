...
app.get('/api/getPairsByCriteria', (req, res) => {
    ...
    pool.query(query, [semester, weekNumber, dayNumber, pairNumber, groupId, groupId, (teacherId = null) ? null : Number(teacherId), (teacherId = null) ? null : Number(teacherId)], (err, result) => {
        if (err) {
            console.error('Error executing query:', err);
